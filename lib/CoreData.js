...
CoreData.activities = [
  ...
  },
  {
    ...
    subActivities: [
      ...
      { key: 'story|base', label: 'Story - Legacy' }
    ],
    type: 'story'
  },
  {
  ...
  },
  {
    ...
    label: 'Strike',
    subActivities: [
      { key: 'strike|shield_brothers', label: 'Strike - Shield Brothers' },
      { key: 'strike|sunless_cell', label: 'Strike - The Sunless Cell' },
      { key: 'strike|fallen_saber', label: 'Strike - Fallen S.A.B.E.R.' },
      { key: 'strike|echo_chamber', label: 'Strike - Echo Chamber (PlayStation Only)' },
      { key: 'strike|shadow_thief', label: 'Strike - The Shadow Thief' },
      { key: 'strike|will_of_crota', label: 'Strike - The Will Of Crota' },
      { key: 'strike|undying_mind', label: 'Strike - The Undying Mind' },
