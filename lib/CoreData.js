...
CoreData.activities = [
  {
    ...
    subActivities: [
      ...
      { key: 'raid|normal|vault_of_glass|gatekeeps_checkpoint', label: 'Vault Of Glass - Normal (Gatekeepers Checkpoint)' },
  ...
  },
  {
    ...
    subActivities: [
      ...
      { key: 'raid|hard|vault_of_glass|gatekeeps_checkpoint', label: 'Vault Of Glass - Hard (Gatekeepers Checkpoint)' },
  ...
  },
  {
    ...
    label: 'Story',
    subActivities: [
      { key: 'story|daily_heroic', label: 'Daily Heroic Story' }
    ],
    type: 'story'
  },
  {
...
/**
 * Maximum fireteam size
 *
 * @type {Number}
 */
CoreData.maxFireteamSize = 6;
